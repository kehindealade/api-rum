                ...
                <div class="card-body">
                    <div class="card-content p-3">
                     ...
                     <div class="card-title text-uppercase text-center py-3"><b>Leaser's </b>Sign In</div>
                       <form method ="POST" action="<?php echo e(route('leaser.login')); ?>">
                         <?php echo csrf_field(); ?>
                          <div class="form-group">
                           <div class="position-relative has-icon-left">
                               <label for="email" class="sr-only"><?php echo e(__('E-Mail Address')); ?></label>
                                 <input type="email" id="exampleInputUsername email" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" placeholder="Email-Address" name="email" value="<?php echo e(old('email')); ?>" required autofocus>
                          ...
                          <div class="form-group">
                           <div class="position-relative has-icon-left">
                              ...
                              <input type="password" id="exampleInputPassword password" class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>"  placeholder="Password" name="password" required>
                              <div class="form-control-position">
