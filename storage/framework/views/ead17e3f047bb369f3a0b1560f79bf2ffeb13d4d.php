    ...
    <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
     ...
     <div id="user-dropdown" class="collapse">
      <ul class="user-setting-menu">
            <li><a href="<?php echo e(route('leaser.profile.index')); ?>"><i class="icon-user"></i>  My Profile</a></li>
      ...
      <li>
         ...
         <a title="LogOut" href="<?php echo e(route('leaser.auth.logout')); ?>"
                                    ...
                                    <form id="logout-form" action="<?php echo e(route('leaser.auth.logout')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                    </form>
